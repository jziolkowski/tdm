...
from PyQt5.QtCore import QDir, QEvent, QRegExp, QSize, QStringListModel, Qt, QTime, pyqtSignal, pyqtSlot
...
class ConsoleWidget(QDockWidget):
    ...
    def __init__(self, settings, device, *args, **kwargs):
        ...
        hl_command_mqttlog.addElements(self.command, pbSave, pbClear, QLabel("MQTT Log level"), self.cbMQTTLog)
...
class DeviceConsoleHistory(QDialog):
    def __init__(self, devices):
        ...
        vl.addElements(gbxDevice, self.lwCommands, QLabel("Double-click a command to use it, ESC to close."))
        self.setLayout(vl)
